...
class _DailyReportReviewScreenState extends State<DailyReportReviewScreen> {
  ...
  void initState() {
    super.initState();
    // We'll load in didChangeDependencies
  }

  @override
  void didChangeDependencies() {
    super.didChangeDependencies();
    // This is a safer place to initialize provider data
    _loadReport();
  }
  ...
  void _selectDate(BuildContext context) async {
    ...
    if (picked != null && picked != _selectedDate) {
      ...
      await Provider.of<DailyReportProvider>(context, listen: false)
          .fetchReportByDate(formattedDate);
    }
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // MOVED: Hours Summary Section - Now above Daily Activities
                    HoursSummary(
                    ...
                    // ADDED: Submit button at the end of the screen
                    if (_canEditReport()) ...[
